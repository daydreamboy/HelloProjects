...
const NSInteger UncaughtExceptionHandlerSkipAddressCount = 0;//4;
...
//        UIAlertController *alert2 = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"Unhandled exception", nil) message:[NSString stringWithFormat:NSLocalizedString(
//                                                                                                                                                                                   @"You can try to continue but the application may be unstable.\n\n"
//                                                                                                                                                                                   @"Debug details follow:\n%@\n%@", nil),
//                                                                                                                                       [exception reason],
...
//    });
    ...
    NSMutableArray *allModesM = [NSMutableArray arrayWithArray:(NSArray *)allModes];
...
{
    NSUncaughtExceptionHandler *handler = &HandleException;
    NSLog(@"handler: %p", handler);
