//
//  AutoFontSizeNotWorkViewController.m
//  HelloUILabel
//
...
@interface AutoFontSizeNotWorkViewController ()
...
@implementation AutoFontSizeNotWorkViewController
...
- (void)sliderValueChanged:(id)sender {
    ...
    self.labelAutoFontSizeSingleLine.font = font;
    self.labelAutoFontSizeMultipleLine.font = font;
    
    //UIFont *adaptiveFont = [WCFontTool adaptiveFontWithInitialFont:font forUILabelSize:self.labelAutoFontSizeSingleLine.bounds.size minimumFontSize:10];
    //NSLog(@"%@", adaptiveFont);
}
