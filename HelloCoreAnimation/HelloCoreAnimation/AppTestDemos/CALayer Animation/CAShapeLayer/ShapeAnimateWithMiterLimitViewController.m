//
//  ShapeAnimateWithMiterLimitViewController.m
//  HelloCoreAnimation
//
...
@interface ShapeAnimateWithMiterLimitViewController ()
@property (nonatomic, strong) CAShapeLayer *layerShape1;
@end

@implementation ShapeAnimateWithMiterLimitViewController
...
- (CAShapeLayer *)layerShape1 {
    if (!_layerShape1) {
        ...
        layer.frame = CGRectMake(20, 30, side, side);
        ...
        // Animate
        CABasicAnimation *animation = [CABasicAnimation animationWithKeyPath:@"miterLimit"];
        ...
        [layer addAnimation:animation forKey:@"miterLimitAnimation"];
