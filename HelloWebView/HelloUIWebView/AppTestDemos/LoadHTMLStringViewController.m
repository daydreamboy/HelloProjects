...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *selectItem = [[UIBarButtonItem alloc] initWithTitle:@"Select" style:UIBarButtonItemStylePlain target:self action:@selector(selectItemClicked:)];
    
    self.navigationItem.rightBarButtonItems = @[loadItem, selectItem];
}
...
- (void)selectItemClicked:(id)sender {
    
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"Choose a html code" message:@"" preferredStyle:UIAlertControllerStyleAlert];
