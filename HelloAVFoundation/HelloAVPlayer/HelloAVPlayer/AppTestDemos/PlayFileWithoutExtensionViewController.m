//
//  PlayFileWithoutExtensionViewController.m
//  HelloAVPlayer
//
...
@interface PlayFileWithoutExtensionViewController ()
@property (nonatomic, strong) UIView *playerView;
@property (nonatomic, strong) AVPlayerItem *item;
@property (nonatomic, strong) AVPlayer *player;
@property (nonatomic, strong) UIImageView *imageView;
@property (nonatomic, strong) WCNSDataAssetResourceLoader *resourceLoader;
@end

@implementation PlayFileWithoutExtensionViewController
...
- (AVPlayerItem *)item {
    if (!_item) {
        NSData *data = [NSData dataWithContentsOfURL:self.URLLocalDemo2];
        
        _resourceLoader = [[WCNSDataAssetResourceLoader alloc] initWithData:data contentType:AVFileTypeMPEG4];
        NSURL *URL = [NSURL URLWithString:@"ns-data-scheme://"];
        // use AVURLAssetReferenceRestrictionsKey, @see https://stackoverflow.com/a/23713109
        AVURLAsset *asset = [[AVURLAsset alloc] initWithURL:URL options:@{AVURLAssetReferenceRestrictionsKey: @(AVAssetReferenceRestrictionForbidNone)}];
        [asset.resourceLoader setDelegate:_resourceLoader queue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)];
