//
//  ShapeLineStrokeBezierPathViewController.m
//  HelloCoreGraphics
//
...
@interface ShapeLineStrokeBezierPathViewController ()
...
@implementation ShapeLineStrokeBezierPathViewController
...
- (CAShapeLayer *)layerShape1 {
    if (!_layerShape1) {
        ...
        layer.lineWidth = 2.0;
        layer.fillColor = nil;
        layer.strokeColor = UICOLOR_RGB(0x317CD6).CGColor;
...
- (CAShapeLayer *)layerShape2 {
    if (!_layerShape2) {
        ...
        layer.lineWidth = 2.0;
        layer.fillColor = nil;
        layer.strokeColor = UICOLOR_RGB(0xFFEE35).CGColor;
        //SHOW_LAYER_BORDER(layer);
...
- (CAShapeLayer *)layerShape3 {
    if (!_layerShape3) {
        ...
        layer.lineWidth = 2.0;
        layer.fillColor = nil;
        layer.strokeColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"pattern1"]].CGColor;
        SHOW_LAYER_BORDER(layer);
