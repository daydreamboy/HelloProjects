...
- (void)showTabledActionSheet {
    TableAlertController *actionSheet = [TableAlertController alertControllerWithTitle:@"Title" message:@"some info" preferredStyle:UIAlertControllerStyleActionSheet];
