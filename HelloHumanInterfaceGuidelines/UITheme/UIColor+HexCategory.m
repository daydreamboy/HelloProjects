...
@implementation UIColor (HexCategory)
...
+ (UIColor *)dg_colorWithHexString:(NSString *)hexString {
    ...
    switch ([colorString length]) {
        ...
        case 8: // #RRGGBBAA
            ...
            break;
        default: {
            NSAssert(NO, @"Color value %@ is invalid. It should be a hex value of the form #RBG, #RGBA, #RRGGBB, or #RRGGBBAA", hexString);
            return nil;
        }
            break;
    }
