//
//  UseSystemColorViewController.m
//  HelloHumanInterfaceGuidelines
//
//  Created by wesley_chen on 2020/3/16.
...
@interface UseSystemColorViewController () <UITableViewDelegate, UITableViewDataSource, MyTableViewCellDelete>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) NSMutableArray<NSString *> *listData;
@end

@implementation UseSystemColorViewController
