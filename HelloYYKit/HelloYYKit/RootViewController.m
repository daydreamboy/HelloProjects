...
- (void)prepareForInit {
    ...
    NSArray<NSDictionary *> *section1 = @[
          @{ kTitle: @"YYAnimatedView not support UIImage", kClass: [MisuseUIImageWithYYAnimatedViewViewController class] },
    ];

    __unused NSArray<NSDictionary *> *section2 = @[
          
    ];
    
    __unused NSArray<NSDictionary *> *section3 = @[
          
    ];
    
    __unused NSArray<NSDictionary *> *section4 = @[
          
    ];
    
    __unused NSArray<NSDictionary *> *section5 = @[
          
    ];
    
    __unused NSArray<NSDictionary *> *section6 = @[
          // TODO
    ];
