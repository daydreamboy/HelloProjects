...
- (void)viewDidLoad {
    ...
    [_stickyHeaderSectionManager addStickyHeaderSection:({
        WCStickyHeaderSection *view = [[WCStickyHeaderSection alloc] initWithInitialY:-200 fixed:0 height:100];
        view.backgroundColor = [[UIColor greenColor] colorWithAlphaComponent:0.5];
        view.sticky = YES; // MARK: set sticky or not
        view;
    })];
    [_stickyHeaderSectionManager addStickyHeaderSection:({
        WCStickyHeaderSection *view = [[WCStickyHeaderSection alloc] initWithInitialY:-100 fixed:0 height:100];
