...
enum MIMSC_REQUEST
{
    ...
    IM_REQ_EHELP_GET_SRV_MODE   = 0x1000081,
    ...
    IM_REQ_GET_READTIMES        = 0x1000214,
    IM_REQ_RENEWAL              = 0x1000300,
    IM_REQ_COMMONCMD            = 0x1000400,
    ...
    CNT_REQ_ADDGROUP            = 0x200000b,
    CNT_REQ_CHGGROUP            = 0x200000c,
    CNT_REQ_DELGROUP            = 0x200000d,
    MISC_REQ_GET_REQUEST        = 0x3000001,
...
enum MIMSC_RESPONSE
{
    ...
    CNT_RSP_ADDGROUP            = 0x201000b,
    CNT_RSP_CHGGROUP            = 0x201000c,
    CNT_RSP_DELGROUP            = 0x201000d,
    MISC_RSP_GET_REQUEST        = 0x3010001,
...
enum MIMSC_NOTIFY
{
    ...
    IM_NTF_ES_SYS_MSG           = 0x1020043,
    IM_NTF_FWD_MSG              = 0x1020091,
    IM_NTF_TRIBE                = 0x1020101,
    IM_NTF_MESSAGE_READ         = 0x1020212,
    IM_NTF_CONFIG               = 0x1020060,
    IM_NTF_CONFIG_CHANGE        = 0x1020061,
