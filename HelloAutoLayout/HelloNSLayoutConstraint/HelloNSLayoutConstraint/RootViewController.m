...
- (void)prepareForInit {
    ...
    NSArray<NSDictionary *> *section1 = @[
          @{ kTitle: @"Plain UITableView", kClass: [ConstraintsByEdgesViewController class] },
          //@{ kTitle: @"Grouped UITableView", kClass: [GroupedTableViewViewController class] },
    ];

    NSArray<NSDictionary *> *section2 = @[
          @{ kTitle: @"Compatible Plain UITableView", kClass: [FrameVSConstraintViewController class] },
