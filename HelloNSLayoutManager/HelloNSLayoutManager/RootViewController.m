...
#import "DrawBackgroundColorInLabelViewController.h"
...
- (void)prepareForInit {
    ...
    NSArray<NSDictionary *> *section1 = @[
          @{ kTitle: @"Underline", kClass: [DrawUnderlineStyleInLabelViewController class] },
          @{ kTitle: @"BackgroundColor", kClass: [DrawBackgroundColorInLabelViewController class] },
    ];
