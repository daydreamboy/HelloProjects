...
+ (void)load {
    ...
    SEL swizzledSelector = [WCObjCRuntimeUtility swizzledSelectorForSelector:originalSelector];
    ...
    [WCObjCRuntimeUtility replaceIMPOfOriginalSelector:originalSelector swizzledSelector:swizzledSelector onClass:[SwizzleMethodByBlockViewController class] withBlock:swizzleBlock];
}
