...
+ (void)load {
    ...
    SEL swizzledKeyEventSelector = [WCObjCRuntimeUtility swizzledSelectorForSelector:originalKeyEventSelector];
    ...
    [WCObjCRuntimeUtility replaceIMPOfOriginalSelector:originalKeyEventSelector swizzledSelector:swizzledKeyEventSelector onClass:[UIApplication class] withBlock:handleKeyUIEventSwizzleBlock];
}
