...
+ (void)inject {
    [WCObjectTool exchangeIMPWithClass:[NSObject class] swizzledIMP:(IMP)MySetBackgroundColor originalSelector:@selector(forwardingTargetForSelector:) originalIMPPtr:(IMP *)&SetBackgroundColorIMP];
}
