//
//  StaticCellAboveiOS11IssuesViewController.m
...
#import "StaticCellAboveiOS11IssuesViewController.h"

@interface StaticCellAboveiOS11IssuesViewController () <UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) NSArray *staticCells;
@end

@implementation StaticCellAboveiOS11IssuesViewController
