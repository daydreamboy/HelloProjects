//
//  AspectRatioScaledImageViewInsideRectViewController2.m
//  HelloUIImageView
//
...
#define BoundingSize CGSizeMake(200, 300)

@interface AspectRatioScaledImageViewInsideRectViewController2 ()
@property (nonatomic, strong) UIImageView *imageView;
@property (nonatomic, strong) UIView *boundingView;
@property (nonatomic, strong) UIScrollView *scrollView;
@end

@implementation AspectRatioScaledImageViewInsideRectViewController2
...
- (UIView *)createBoundingViewWithImageName:(NSString *)imageName atY:(CGFloat)y {
    ...
    CGRect aspectScaledRect = [WCViewTool safeAVMakeAspectRatioRectWithContentSize:image.size insideBoundingRect:view.bounds]; 
