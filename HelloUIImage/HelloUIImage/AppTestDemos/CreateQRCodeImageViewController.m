...
- (UITextView *)textView {
    if (!_textView) {
        ...
        CGFloat paddingH = 10;
        UITextView *textView = [[UITextView alloc] initWithFrame:CGRectMake(paddingH, paddingH, screenSize.width - 2 * paddingH, 200)];
...
- (void)textViewDidEndEditing:(UITextView *)textView {
    self.imageViewQRCode.image = [WCImageTool QRImageWithString:textView.text size:self.imageViewQRCode.bounds.size];
}
