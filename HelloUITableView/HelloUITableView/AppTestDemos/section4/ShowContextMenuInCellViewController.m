//
//  ShowContextMenuInCellViewController.m
//  HelloUITableView
//
...
@interface ShowContextMenuInCellViewController () <UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) NSArray<NSArray<NSString *> *> *listData;
@end

@implementation ShowContextMenuInCellViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *sCellIdentifier = @"ShowContextMenuInCellViewController_sCellIdentifier";
