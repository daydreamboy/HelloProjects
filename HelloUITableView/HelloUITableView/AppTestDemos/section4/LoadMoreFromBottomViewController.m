...
#pragma GCC diagnostic pop
        ...
        WCTableLoadMoreView *view = [[WCTableLoadMoreView alloc] initWithTableView:tableView viewController:self frame:CGRectMake(0, 0, CGRectGetWidth(tableView.bounds), 60) loadMoreType:WCTableLoadMoreTypeFromBottom];
