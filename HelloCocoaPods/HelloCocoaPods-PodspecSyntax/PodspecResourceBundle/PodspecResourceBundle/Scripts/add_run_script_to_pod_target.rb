...
# Configurations
run_script_name = '[My] Run Script'
target_name = 'PodspecResourceBundle'
...
project.targets.each do |target|
  if target.name == target_name
    ...
    if copy_to_pods_phase_exists
      ...
      # Note: ${PROJECT_DIR} is based on Pods.xcodeproj
      new_phase.shell_script = 'bash "${PROJECT_DIR}/../../PodspecResourceBundle/Scripts/embed_bundle_in_bundle.sh"'
    end
  end
end
