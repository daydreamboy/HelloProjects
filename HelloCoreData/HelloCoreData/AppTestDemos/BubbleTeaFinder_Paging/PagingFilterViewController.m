...
#import "PagingFilterViewController.h"
#import <CoreData/CoreData.h>

@interface PagingFilterViewController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation PagingFilterViewController
...
- (void)searchItemClicked:(id)sender {
    if ([self.delegate respondsToSelector:@selector(PagingFilterViewController:didSelectPredicate:sortDescriptor:)]) {
        [self.delegate PagingFilterViewController:self didSelectPredicate:self.selectedPredicate sortDescriptor:self.selectedSortDescriptor];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *sCellIdentifier1 = @"PagingFilterViewController_sCellIdentifier1";
    static NSString *sCellIdentifier2 = @"PagingFilterViewController_sCellIdentifier2";
