//
//  DrawStringWithSimpleLayoutV1ViewController.m
//  HelloCoreText
//
...
@interface DrawStringWithSimpleLayoutV1ViewController ()

@end

@implementation DrawStringWithSimpleLayoutV1ViewController
