//
//  PagableCollectionViewViewController.m
...
@interface PagableCollectionViewViewController () <UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation PagableCollectionViewViewController
...
- (void)setupCommonConfiguration:(UICollectionView *)view {
...
- (UICollectionView *)collectionView1 {
    if (!_collectionView1) {
        ...
        [self setupCommonConfiguration:view];
